...
export const MercedesVip: React.FC = () => {
  const { language, t } = useLanguage();
  const seo = SEO_CONFIGS.mercedesVip[language];
  const productSchema = getProductSchema(
    language === "ar" ? "مرسيدس VIP ورجال الأعمال" : "VIP Mercedes Sprinter & V-Class",
    19,
    language
  );
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://hafilah.com/services/mercedes-vip" />
        <meta property="og:image" content="https://hafilah.com/images/buses/mercedes-sprinter.webp" />
        <link rel="canonical" href="https://hafilah.com/services/mercedes-vip" />
      ...
      <section className="bg-slate-950 text-white py-20 px-4 md:px-8 text-center relative overflow-hidden border-b-4 border-amber-500">
        ...
        <div className="max-w-4xl mx-auto z-10 relative space-y-4">
          <div className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full text-xs font-bold bg-amber-500/20 text-amber-400 border border-amber-500/30 mb-2">
            ...
            <span>{isAr ? "خدمات التنقل الفاخرة" : "ROYAL CHAUFFEUR SERVICE"}</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight text-white">
            {t("service.mercedes.title")}
          </h1>
          <p className="text-slate-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
            {t("service.mercedes.subtitle")}
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-7 space-y-8 text-start">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 space-y-6">
                <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2 border-b border-gray-100 pb-3">
                  ...
                  {isAr ? "معرض سيارات مرسيدس VIP" : "Mercedes VIP Fleet Gallery"}
                </h3>
                  ...
                  <div className="bg-slate-50 rounded-xl overflow-hidden border border-gray-200/60 shadow-sm flex flex-col group">
                    <div className="h-48 overflow-hidden relative bg-white flex items-center justify-center p-2">
                      <img 
                        ...
                        alt={t("service.mercedes.gallerySide")} 
                    ...
                    <div className="p-3 flex-grow bg-slate-900 text-white text-center">
                      <h4 className="font-bold text-sm text-amber-400">{t("service.mercedes.gallerySide")}</h4>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 rounded-xl overflow-hidden border border-gray-200/60 shadow-sm flex flex-col group">
                    <div className="h-48 overflow-hidden relative bg-white flex items-center justify-center p-2">
                      <img 
                        ...
                        alt={t("service.mercedes.galleryInside")} 
                        className="w-full h-full object-contain group-hover:scale-105 transition duration-500"
                        onError={(e) => {
                    ...
                    <div className="p-3 flex-grow bg-slate-900 text-white text-center">
                      <h4 className="font-bold text-sm text-amber-400">{t("service.mercedes.galleryInside")}</h4>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-gray-600 text-sm">
                    ...
                    <span>{isAr ? "مقاعد جلدية مريحة للغاية بنظام كراسي الطائرة ومثبتات مريحة." : "Highly comfortable premium leather airline captain chairs."}</span>
                  </li>
                  <li className="flex items-center gap-3 text-gray-600 text-sm">
                    <FaCheckCircle className="text-amber-500 flex-shrink-0" />
                    <span>{isAr ? "شاشات عرض ذكية وإنترنت مجاني مع مقابس طاقة لشحن الأجهزة." : "Smart screens and free high-speed Wi-Fi with USB power ports."}</span>
                  </li>
                  <li className="flex items-center gap-3 text-gray-600 text-sm">
                    <FaCheckCircle className="text-amber-500 flex-shrink-0" />
                    <span>{isAr ? "ثلاجة مشروبات خاصة لتقديم الضيافة والمياه الباردة طوال الرحلة." : "Private beverage cooler for VIP hospitality and cold mineral water."}</span>
                  </li>
                  <li className="flex items-center gap-3 text-gray-600 text-sm">
                    <FaCheckCircle className="text-amber-500 flex-shrink-0" />
                    <span>{isAr ? "سائق محترف وملتزم بارتداء البدلة الرسمية وبروتوكولات استقبال كبار الشخصيات." : "Dedicated suit-and-tie executive chauffeur strictly adhering to protocols."}</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className={`p-4 bg-slate-50 rounded-xl ${isAr ? "border-r-4" : "border-l-4"} border-slate-900`}>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">{t("service.mercedes.use1Title")}</h4>
                    <p className="text-xs text-gray-500">{t("service.mercedes.use1Desc")}</p>
                  </div>
                  <div className={`p-4 bg-slate-50 rounded-xl ${isAr ? "border-r-4" : "border-l-4"} border-slate-900`}>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">{t("service.mercedes.use2Title")}</h4>
                    <p className="text-xs text-gray-500">{t("service.mercedes.use2Desc")}</p>
                  </div>
                  <div className={`p-4 bg-slate-50 rounded-xl ${isAr ? "border-r-4" : "border-l-4"} border-slate-900`}>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">{t("service.mercedes.use3Title")}</h4>
                    <p className="text-xs text-gray-500">{t("service.mercedes.use3Desc")}</p>
                  </div>
                  <div className={`p-4 bg-slate-50 rounded-xl ${isAr ? "border-r-4" : "border-l-4"} border-slate-900`}>
                    <h4 className="font-bold text-slate-900 text-sm mb-1">{t("service.mercedes.use4Title")}</h4>
                    <p className="text-xs text-gray-500">{t("service.mercedes.use4Desc")}</p>
                  </div>
                </div>
              </div>
